...
.history-modal__state.is-error, .history-modal__message-state.is-error { flex-direction: column; color: #d05b48; }
.history-modal__state button, .history-modal__message-state button { padding: 5px 12px; border: 1px solid #cbd9ef; border-radius: 6px; background: #fff; color: #4384e8; cursor: pointer; }
.history-modal__message-state { display: flex; align-items: center; justify-content: center; gap: 8px; margin-top: 9px; padding: 8px; border-radius: 8px; background: #f5f7fb; color: #8b929d; font-size: 11px; text-align: center; }
</style>
